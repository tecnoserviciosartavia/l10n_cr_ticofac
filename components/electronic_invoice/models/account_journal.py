...
class AccountJournalInherit(models.Model):
    ...
    _description = 'Account Journal Inherit'
    ...
    FE_sequence_id = fields.Many2one(
        ...
        check_company=True,      # Valida que la secuencia pertenezca a la compañía
        copy=False
    )
    ...
    FEC_sequence_id = fields.Many2one(
        comodel_name="ir.sequence",
        string="Sequence of Purchase Invoices",
        check_company=True,      # Valida que la secuencia pertenezca a la compañía
        copy=False
    )
    ...
    REP_sequence_id = fields.Many2one(
        comodel_name="ir.sequence", string="Electronic Payment Receipt Sequence"
    )
